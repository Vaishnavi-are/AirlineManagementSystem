...
<script>
    ...
    <style>
        ...
        @keyframes blink {
            ...
            50% {
                border: 2px solid #fff; /* White border */
                background-color: #555; /* Even darker gray background */
            }
        }

        .developer:hover {
            animation: none; /* Disable blink animation on hover */
            box-shadow: 0 0 20px rgba(255, 255, 255, 0.6); /* Increased shadow on hover */
        }
        ...
        .info h2 {
            margin-top: 0;
            font-size: 18px; /* Font size for developer name */
            margin-bottom: 5px; /* Add space below name */
            text-transform: uppercase; /* Uppercase name */
        }

        .info p {
            margin: 0;
            font-size: 14px; /* Font size for other info */
            margin-bottom: 3px; /* Add space below each line */
        }
...
<h1><center>Developer Information</center></h1>
    <div class="container">
        ...
        <div class="developer" id="developer4">
            ...
            <div class="info">
                ...
                <p>Qualification: CSE Diploma Student (III year)</p>
                <a href="https://www.linkedin.com/in/vaishnavi-are-4552242b3?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">LinkedIn</a>
            </div>
        </div>
    </div>
</body>
